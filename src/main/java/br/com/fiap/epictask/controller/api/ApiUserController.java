...
public class ApiUserController {
	...
	public Page<User> index(
			...
			String user, @PageableDefault Pageable pageable)  {
		
		if (user == null) {
			
			return repository.findAll(pageable);
		}
		return repository.findByNameLike("%" + user + "%", pageable);
	...
	@PutMapping("{id}")
	@CacheEvict(value = "users", allEntries = true)
	public ResponseEntity<User> update(@PathVariable Long id, @RequestBody @Valid
			User newUser) {
